...
# key (AKA name): string
# e.g. "id"
# value: number (e.g. 1234), string (e.g. "1234AZ"), array (e.g. [1, 2, 3, 4])
# boolean (e.g. true), a JSON object (e.g. nesting)
...
# lets create a json object (which will be a python list in this case)
...
# lets read the actigraph data from a file
